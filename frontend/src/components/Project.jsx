      ...
      <div className='container'>
        ...
        <div className='flex flex-col mt-10 md:mt-16 gap-20 items-center'>
          {portfolioProjects.map ((item) =>(
            <div key={item.id} className='bg-gradient-to-r from-color-1/5 to-n-11/10    rounded-3xl z-0  after:z-10 relative after:content-[""]  after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl  px-8 pt-8 after:pointer-events-none md:pt-12 md:px-10 lg:pt-16 lg:px-20 overflow-hidden  w-3/4'>
